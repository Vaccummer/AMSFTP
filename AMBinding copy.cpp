...
private:
  py::class_<ClassType, std::shared_ptr<ClassType>> *cls_ptr;
...
public:
  AutoDefHelper(py::class_<ClassType, std::shared_ptr<ClassType>> &cls,
                const char *name, FuncType func)
      : cls_ptr(&cls), func_name(name), func_ptr(func) {}

  // Add argument without default value
  ...
  template <typename T> AutoDefHelper &arg(const char *name, T &&default_val) {
...
private:
  void bind_1arg() {
    auto &a0 = args_info[0];
    if (a0.has_default) {
      cls_ptr->def(func_name, func_ptr, py::arg(a0.name.c_str()) = a0.value,
                   func_doc.c_str());
    } else {
  ...
  void bind_2arg() {
    ...
    if (a0.has_default && a1.has_default) {
      cls_ptr->def(func_name, func_ptr, py::arg(a0.name.c_str()) = a0.value,
                   py::arg(a1.name.c_str()) = a1.value, func_doc.c_str());
    } else if (!a0.has_default && a1.has_default) {
      cls_ptr->def(func_name, func_ptr, py::arg(a0.name.c_str()),
                   py::arg(a1.name.c_str()) = a1.value, func_doc.c_str());
    } else {
      cls_ptr->def(func_name, func_ptr, py::arg(a0.name.c_str()),
                   py::arg(a1.name.c_str()), func_doc.c_str());
    }
  }
  ...
  void bind_3arg() {
    ...
    if (!a0.has_default && !a1.has_default && a2.has_default) {
      cls_ptr->def(func_name, func_ptr, py::arg(a0.name.c_str()),
                   py::arg(a1.name.c_str()),
                   py::arg(a2.name.c_str()) = a2.value, func_doc.c_str());
    } else if (a0.has_default && a1.has_default && a2.has_default) {
      cls_ptr->def(func_name, func_ptr, py::arg(a0.name.c_str()) = a0.value,
                   py::arg(a1.name.c_str()) = a1.value,
                   py::arg(a2.name.c_str()) = a2.value, func_doc.c_str());
    } else {
      cls_ptr->def(func_name, func_ptr, py::arg(a0.name.c_str()),
  ...
  void bind_4arg() {
    ...
    cls_ptr->def(func_name, func_ptr, py::arg(a0.name.c_str()),
                 py::arg(a1.name.c_str()), py::arg(a2.name.c_str()),
                 py::arg(a3.name.c_str()), func_doc.c_str());
  }
  ...
  void bind_6arg() {
    ...
    cls_ptr->def(func_name, func_ptr, py::arg(a0.name.c_str()),
                 py::arg(a1.name.c_str()), py::arg(a2.name.c_str()),
                 py::arg(a3.name.c_str()), py::arg(a4.name.c_str()),
                 py::arg(a5.name.c_str()), func_doc.c_str());
  }
...
auto_def(py::class_<ClassType, std::shared_ptr<ClassType>> &cls,
         const char *func_name, FuncType func_ptr) {
