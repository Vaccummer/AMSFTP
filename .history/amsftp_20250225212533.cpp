...
PYBIND11_MODULE(AMSFTP, m)
{
    ...
    py::class_<AMSFTPClient>(m, "AMSFTPClient")
        ...
        .def("stat", &AMSFTPClient::stat)
        .def("exists", &AMSFTPClient::exists, py::arg("path"))
        .def("is_file", &AMSFTPClient::is_file)
        .def("is_dir", &AMSFTPClient::is_dir)
        .def("is_symlink", &AMSFTPClient::is_symlink)
        .def("listdir", &AMSFTPClient::listdir)
        .def("mkdir", &AMSFTPClient::mkdir)
        .def("mkdirs", &AMSFTPClient::mkdirs);
}
