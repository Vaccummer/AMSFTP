...
static std::string AMLEVEL = "AMLEVEL";
static std::string AMERRORNAME = "AMERRORNAME";
static std::string AMTARGET = "AMTARGET";
static std::string AMACTION = "AMACTION";
static std::string AMMESSAGE = "AMMESSAGE";

static std::string AMCRITICAL = "CRITICAL";
static std::string AMWARNING = "WARNING";
static std::string AMINFO = "INFO";
static std::string AMDEBUG = "DEBUG";
    ...
    void pytrace(std::string level, std::string error_name = "", std::string target = "", std::string action = "", std::string msg = "")
    {
        if (is_trace.load(std::memory_order_relaxed))
        {
            std::unordered_map<std::string, std::string> level_map = {
                {std::string(AMLEVEL), level},
                {std::string(AMERRORNAME), error_name},
                {std::string(AMTARGET), target},
                {std::string(AMACTION), action},
                {std::string(AMMESSAGE), msg},
            };
            trace_cb(level_map);
            // trace_cb(error_info);
        }
