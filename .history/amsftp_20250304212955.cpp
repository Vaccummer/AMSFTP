...
PYBIND11_MODULE(AMSFTP, m)
{
    py::enum_<TransferErrorCode>(m, "TransferErrorCode")
        ...
        .value("InvalidState", TransferErrorCode::InvalidState)
        .value("InvalidArgument", TransferErrorCode::InvalidArgument)
        .value("InvalidOperation", TransferErrorCode::InvalidOperation)
