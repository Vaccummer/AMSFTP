...
private:
    ...
    EC _legacy()
    {
        // EC _Local2Remote2(const std::string &src, const std::string &dst, uint64_t &chunk_size)
        // {
        ...
        // EC _Remote2Remote_ori(const std::string &src, const std::string &dst, std::shared_ptr<AMSFTPWorker> another_worker)
        // {
        ...
        // EC _Remote2Remote2(const std::string &src, const std::string &dst, std::shared_ptr<AMSFTPWorker> another_worker)
        // {
        //     TransferErrorCode rc_final = EC::Success;
        //     long rct;
        //     LIBSSH2_SFTP_HANDLE *srcFile;
    ...
    EC Local2Remote(const std::string &src, const std::string &dst, uint64_t &chunk_size)
    {
        TransferErrorCode rc_r = EC::Success;
        long rct;
        LIBSSH2_SFTP_HANDLE *sftpFile;
    ...
    EC Remote2Local(const std::string &src, const std::string &dst, uint64_t &chunk_size)
    {
    ...
    EC Remote2Remote(const std::string &src, const std::string &dst, std::shared_ptr<AMSFTPWorker> another_worker, uint64_t &chunk_size)
    {
        TransferErrorCode rc_final = EC::Success;
        long rct;
        LIBSSH2_SFTP_HANDLE *srcFile;
