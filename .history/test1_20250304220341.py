...
request = ConRequst(hostname=hostname, username=username, password=password, tar_system=TarSystemType.Unix, compression=False, port=port, trash_dir=r'F:\Windows_Data\Desktop_File\Trash', test_path='/home/am')
...
wrapper = AMSFTPWorker(0, keys, request, set, callback, tasks)
