...
struct BufferSet
{
    ...
    BufferSet()
        : buffer_sizes({16 * 1024 * 1024, 8 * 1024 * 1024, 4 * 1024 * 1024, 1024 * 1024, 258 * 1024, 128 * 1024, 64 * 1024}),
          buffer_sizes_limit({16 * 1024 * 1024 * 1024, 4 * 1024 * 1024 * 1024, 1024 * 1024 * 1024, 512 * 1024 * 1024, 50 * 1024 * 1024, 10 * 1024 * 1024, 0}) {}
