...
PYBIND11_MODULE(AMSFTP, m)
{
    ...
    py::class_<PathInfo>(m, "PathInfo")
        .def(py::init<std::string, std::string, uint64_t, uint64_t, uint64_t, PathType>(), py::arg("name"), py::arg("path"), py::arg("dir"), py::arg("size"), py::arg("atime"), py::arg("mtime"), py::arg("path_type"))
