...
public:
    ...
    EC ensure_trash_dir()
    {
        ...
        if (std::holds_alternative<PathInfo>(info))
        {
            ...
            {
                error_info_buffer.push(ErrorInfo(EC::TargetNotADirectory, request.trash_dir, "", "AMSFTPClient::ensure_trash_dir", "Trash dir: " + request.trash_dir + " is not a directory"));
