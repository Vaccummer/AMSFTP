...
struct SingleBuffer
{
    std::shared_ptr<char[]> bufferptr_origin = nullptr;
    ...
    {
        // this->bufferptr_origin = std::make_shared<char[]>(buffer_size);
        // this->bufferptr = this->bufferptr_origin.get();
        this->bufferptr = new char[buffer_size];
    }
};
