...
static std::string AMLEVEL = "LEVEL";
static std::string AMERRORNAME = "ERRORNAME";
static std::string AMTARGET = "TARGET";
static std::string AMACTION = "ACTION";
static std::string AMMESSAGE = "MESSAGE";
