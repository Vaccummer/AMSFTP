...
PYBIND11_MODULE(AMSFTP, m)
{
    ...
    py::class_<TransferCallback>(m, "TransferCallback")
        .def(py::init<py::function, py::function, py::function, float>(), py::arg("error_cb") = py::none(), py::arg("progress_cb") = py::none(), py::arg("filename_cb") = py::none(), py::arg("cb_interval_s") = 0.5)
