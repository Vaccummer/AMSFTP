    ...
    EC init()
    {
        ...
        if (!request.password.empty())
        {
            ...
            for (auto &private_key : private_keys)
            {
                ...
                if (rca == 0)
                {
                    msg = "Public key \"" + private_key + "\" authorize success";
        ...
        OK:
            ...
            if (request.trash_dir.empty())
            {
                ...
                pytrace(INFO, "TrashDirSet", "TrashDir", "DefaultTrashDir", "Trash directory set to " + trash_dir_t);
            }
