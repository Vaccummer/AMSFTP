        ...
        {
            {
                ...
                else
                {
                    ...
                    pytrace("Info", "AuthorizeError", request.nickname, "PasswordAuthorize", "Password authorize failed");
                }
            }
            for (auto &private_key : private_keys)
            {
                pytrace("Info", "AuthorizeError", request.nickname, "PublicKeyAuthorize", "Public key");
