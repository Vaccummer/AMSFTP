...
struct TransferCallback
{
    ...
    TransferCallback(float cb_interval_s, py::object error_cb = py::none(), py::object progress_cb = py::none(), py::object filename_cb = py::none())
...
PYBIND11_MODULE(AMSFTP, m)
{
    ...
    py::class_<TransferCallback>(m, "TransferCallback")
        .def(py::init<py::function, py::function, py::function, float>(), py::arg("error_cb") = py::function(), py::arg("progress_cb") = py::function(), py::arg("filename_cb") = py::function(), py::arg("cb_interval_s") = 0.5)
