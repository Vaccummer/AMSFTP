...
struct TransferCallback
{
    ...
    TransferCallback()
        : progress_cb(py::function()), filename_cb(py::function()), error_cb(py::function()), cb_interval_ms(0.5), total_bytes(1000), need_progress_cb(false), need_filename_cb(false), need_error_cb(false) {}
