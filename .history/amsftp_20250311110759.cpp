...
private:
    ...
    EC Local2Remote(std::string src, std::string dst)
    {
        ...
        if (!sftpFile)
        {
            ...
            {
                pytrace(ERROR, "RemoteFileOpenError", fmt::format("{}@{}->{}", request.nickname, src, dst), "Remote2Local", get_sftp_error_msg());
                return EC::RemoteFileOpenError;
            }
        }
        ...
        if (!l_file_m.file_ptr)
        {
            ...
            pytrace(ERROR, "LocalFileMapError", fmt::format("{}@{}->{}", request.nickname, src, dst), "Local2Remote", error_msg);
        ...
        while (remaining > 0)
        {
            ...
            {
                pytrace(ERROR, "RemoteFileWriteError", fmt::format("{}@{}->{}", request.nickname, src, dst), "Local2Remote", get_sftp_error_msg());
