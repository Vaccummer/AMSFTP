...
public:
    ...
    AMSFTPWorker(uint64_t ID, std::vector<std::string> private_keys, TransferSet set, TransferCallback callback, TASKS tasks, ConRequst src_request, ConRequst dst_request)
