...
PYBIND11_MODULE(AMSFTP, m)
{
    ...
    py::class_<AMSFTPWorker>(m, "AMSFTPWorker")
        .def(py::init<std::vector<std::string>, TASKS, ConRequst, ConRequst>(), py::arg("ID"), py::arg("private_keys"), py::arg("callback"), py::arg("tasks"), py::arg("src_request") = ConRequst(), py::arg("dst_request") = ConRequst())
        ...
        .def("toAnotherHost", &AMSFTPWorker::toAnotherHost, py::arg("tasks"), py::arg("another_client"), py::arg("cb_set") = TransferCallback(), py::arg("buffer_set") = BufferSet());
}
