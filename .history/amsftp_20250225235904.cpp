...
EC cast_libssh2_error(int error_code)
{
    ...
    case LIBSSH2_ERROR_INVAL:
        ...
        csae LIBSSH2_ERROR_MAC_FAILURE : return EC::MACAuthFailed;
    case LIBSSH2_ERROR_HOST_KEY_INIT:
        return EC::HostKeyInitError;
    case LIBSSH2_ERROR_HOST_KEY_CHECK_MISMATCH:
        return EC::HostKeyCheckMismatch;
    case LIBSSH2_ERROR_HOST_KEY_CHECK_MISSING:
        return EC::HostKeyCheckMissing;

    case LIBSSH2_ERROR_SOCKET_TIMEOUT:
        return EC::SocketTimeout;
    case LIBSSH2_ERROR_SFTP_PROTOCOL:
        return EC::SftpProtocolError;
    case LIBSSH2_ERROR_SCP_PROTOCOL:
        return EC::ScpProtocolError;
