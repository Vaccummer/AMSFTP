...
private:
    ...
    clean:
        ...
        case EC::Terminate:
            ...
            break;
        case EC::NetworkDisconnect:
            pytrace(ERROR, "NetworkDisconnect", fmt::format("{}@{}->Local@{}", request.nickname, src, dst), "Remote2Local", "Network broken");
            break;
        default:
    ...
    {
        std::cout << "Remote2Remote" << std::endl;
        TransferErrorCode rc_final = EC::Success;
        long rct;
        LIBSSH2_SFTP_HANDLE *srcFile;
        LIBSSH2_SFTP_HANDLE *dstFile;
