...
private:
    ...
    clean:
        ...
        case EC::NetworkDisconnect:
            pytrace(ERROR, "NetworkDisconnect", fmt::format("Local@{}->{}@{}", src, request.nickname, dst), "Local2Remote", "Network disconnected");
            break;
        default:
    ...
    EC Remote2Local(std::string src, std::string dst)
    {
        ...
        {
            libssh2_sftp_close_handle(sftpFile);
            pytrace(ERROR, "LocalFileMapError", dst, "Remote2Local", error_msg);
