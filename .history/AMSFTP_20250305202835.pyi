...
class AMSFTPClient:
    ...
    def move(self, src: str, dst: str)->TransferErrorCode:
        ...
    
    def copy(self, src: str, dst: str)->TransferErrorCode:
        ...
    
    def rename(self, src: str, dst: str)->TransferErrorCode:
        ...
    
    def rename_p(self, src: str, dst: str)->TransferErrorCode:
        ...
    
    def rename_r(self, src: str, dst: str)->TransferErrorCode:
        ...
