...
PYBIND11_MODULE(AMSFTP, m)
{
    ...
    py::class_<ConRequst>(m, "ConRequst")
        .def(py::init<std::string, std::string, std::string, int, TarSystemType, bool, std::string>(), py::arg("hostname"), py::arg("username"), py::arg("password"), py::arg("port"), py::arg("tar_system"), py::arg("compression"), py::arg("test_path"))
