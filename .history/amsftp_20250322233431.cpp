...
struct ConRequst
{
    ...
    ConRequst()
        : nickname(L""), hostname(L""), username(L""), password(L""), port(22), compression(false), timeout_s(3), trash_dir(L"") {}
    ConRequst(std::wstring nickname, std::wstring hostname, std::wstring username, std::wstring password, int port, bool compression, size_t timeout_s = 3, std::wstring trash_dir = L"")
