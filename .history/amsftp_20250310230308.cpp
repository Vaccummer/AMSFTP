...
public:
    ...
    EC init()
    {
        ...
        {
            {
                ...
                {
                    std::string msg = "Password \"" + request.password + "\" authorize failed";
                    pytrace("Warning", "AuthorizeError", request.nickname, "PasswordAuthorize", msg);
                }
            }
            for (auto &private_key : private_keys)
            {
                std::string msg = "Public key \"" + private_key + "\" authorize failed";
                ...
                if (rca == 0)
                {
                    std::string msg = "Public key \"" + private_key + "\" authorize success";
        ...
        OK:
            ...
            {
                pytrace("Critical", "AuthorizeError", request.nickname, "Authorize", "Authorize failed");
                return rc;
            }
            {
