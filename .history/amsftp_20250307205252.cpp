...
public:
    ...
    AMSFTPWorker(uint64_t ID, std::vector<std::string> private_keys, ConRequst src_request, ConRequst dst_request, TransferSet set, TransferCallback callback, TASKS tasks)
