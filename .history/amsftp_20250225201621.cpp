...
uint64_t AMKB = 1024 * 1024;
uint64_t AMMB = 1024 * 1024 * 1024;
uint64_t AMGB = 1024 * 1024 * 1024 * 1024;
...
struct BufferSet2
{
    ...
    BufferSet()
        : A_buffer(16 * 1024 * 1024), A_size(16 * 1024 * 1024 * 1024),
          B_buffer(8 * 1024 * 1024), B_size(4 * 1024 * 1024 * 1024),
          C_buffer(4 * 1024 * 1024), C_size(1024 * 1024 * 1024),
          D_buffer(1024 * 1024), D_size(512 * 1024 * 1024),
          E_buffer(258 * 1024), E_size(50 * 1024 * 1024),
          F_buffer(128 * 1024), F_size(10 * 1024 * 1024),
          G_buffer(64 * 1024), G_size(0) {}
    BufferSet(std::vector<uint64_t> buffer_sizes, )
};
...
struct BufferSet
{
    ...
    BufferSet()
        : buffer_sizes({BufferSizePair{16 * AMGB, 16 * AMMB},
                        BufferSizePair{4 * AMGB, 8 * AMKB},
                        BufferSizePair{4 * AMMB, AMMB},
                        BufferSizePair{AMMB, 512 * AMKB},
                        BufferSizePair{258 * AMKB, 50 * AMKB},
                        BufferSizePair{128 * AMKB, 10 * AMKB},
                        BufferSizePair{64 * AMKB, 0}}) {}
    BufferSet(std::vector<BufferSizePair> buffer_sizes)
    {
    }
};
