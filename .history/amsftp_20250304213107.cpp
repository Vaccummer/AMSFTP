...
PYBIND11_MODULE(AMSFTP, m)
{
    py::enum_<TransferErrorCode>(m, "TransferErrorCode")
        ...
        .value("InvalidFilename", TransferErrorCode::InvalidCast)
        ...
        .value("SftpNotInitialized", TransferErrorCode::NoSuchFile)
        .value("SessionNotInitialized", TransferErrorCode::NoSuchPath)
        .value("NoSuchUser", TransferErrorCode::NoSuchUser)
        .value("NoSuchHost", TransferErrorCode::NoSuchHost)
        .value("NoSuchPort", TransferErrorCode::NoSuchPort)
        .value("NoSuchUser", TransferErrorCode::NoSuchUser)
