...
public:
  ...
  /**
   * @brief Create a new control token with explicit caller ownership.
   *
  ...
  /**
   * @brief Transitional global accessor kept for compatibility only.
   *
   * @deprecated Use explicit dependency injection with CreateShared() instead.
   * TODO(WF6): Remove this accessor after bootstrap/session ownership cutover.
   */
