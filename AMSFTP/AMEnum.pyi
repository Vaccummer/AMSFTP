...
class ErrorCode:
    ...
    ClientNotFound: typing.ClassVar[ErrorCode]  # value = <ErrorCode.ClientNotFound: 40>
    ...
    DeepcopyFailed: typing.ClassVar[ErrorCode]  # value = <ErrorCode.DeepcopyFailed: 44>
    DeepcopyFunctionNotAvailable: typing.ClassVar[ErrorCode]  # value = <ErrorCode.DeepcopyFunctionNotAvailable: 42>
    ...
    KeyAlreadyExists: typing.ClassVar[ErrorCode]  # value = <ErrorCode.KeyAlreadyExists: 43>
