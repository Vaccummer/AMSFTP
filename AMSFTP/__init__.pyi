...
class AMSFTPClient(BaseSFTPClient):
    ...
    def __init__(
        ...
        keys: list[str],
        error_num: int = 10,
        trace_cb: typing.Any = None,
    ) -> None: ...
    def chmod(
        self, path: str, mode: str | int, recursive: bool = False
    ) -> dict[str, tuple[ErrorCode, str]] | tuple[ErrorCode, str]: ...
    def copy(
    ...
    def getsize(
        self, path: str, ignore_sepcial_file: bool = True, trace_link: bool = False
    ) -> int | tuple[ErrorCode, str]: ...
    def is_dir(
        self, path: str, trace_link: bool = False
    ) -> bool | tuple[ErrorCode, str]: ...
    def is_regular(
        self, path: str, trace_link: bool = False
    ) -> bool | tuple[ErrorCode, str]: ...
    def is_symlink(self, path: str) -> bool | tuple[ErrorCode, str]: ...
    def listdir(
        self, path: str, max_time_ms: int = -1, trace_link: bool = True
    ) -> list[PathInfo] | tuple[ErrorCode, str]: ...
    def mkdir(self, path: str) -> tuple[ErrorCode, str]: ...
    def mkdirs(self, path: str) -> tuple[ErrorCode, str]: ...
    def mklink(
        self, path: str, link_path: str, mkdir: bool
    ) -> tuple[ErrorCode, str]: ...
    def move(
        self, src: str, dst: str, need_mkdir: bool = False, force_write: bool = False
    ) -> tuple[ErrorCode, str]: ...
    def parsepath(self, path: str) -> str | tuple[ErrorCode, str]: ...
    ...
    def rmtree(
        self, path: str
    ) -> list[tuple[str, tuple[ErrorCode, str]]] | tuple[ErrorCode, str]: ...
    def saferm(self, path: str) -> tuple[ErrorCode, str]: ...
    def stat(
        self, path: str, trace_link: bool = False
    ) -> PathInfo | tuple[ErrorCode, str]: ...
    def walk(
        self, path: str, ignore_sepcial_file: bool = True, trace_link: bool = False
    ) -> list[PathInfo] | tuple[ErrorCode, str]: ...
...
class AMSFTPWorker(AMSFTPClient):
    ...
    def LoadTasks(
        self, src: str, dst: str, trace_link: bool, is_src_remote: bool = True
    ) -> list[TransferTask] | tuple[ErrorCode, str]: ...
    def __init__(
        self,
        request: ConRequst,
        keys: list[str],
    ...
    def download(
        ...
        list[tuple[tuple[str, str], tuple[ErrorCode, str]]] | tuple[ErrorCode, str]
    ): ...
    def get(
        self,
        src: str,
...
class AMTracer:
    def Clear(self) -> None: ...
    def GetAllErrors(self) -> list[dict[str, str | ErrorCode]]: ...
    ...
    def __init__(
        self, buffer_capacity: int = 10, trace_cb: typing.Any = None
    ) -> None: ...
    def pause(self) -> None: ...
    def resume(self) -> None: ...
    def trace(
        self, arg0: str, arg1: ErrorCode, arg2: str, arg3: str, arg4: str
    ) -> None: ...

class BaseSFTPClient:
    def CheckCon(self) -> tuple[ErrorCode, str]: ...
    def EnsureCon(self) -> tuple[ErrorCode, str]: ...
    def ExcuteCmd(self, cmd: str) -> tuple[str, int] | tuple[ErrorCode, str]: ...
    def GetHomeDir(self) -> str: ...
    def GetOSType(self) -> OS_TYPE: ...
    def GetRTT(self, arg0: int) -> float: ...
    def GetTrashDir(self) -> str: ...
    def Initialize(self) -> tuple[ErrorCode, str]: ...
...
class ErrorCode:
    ...
    AlgorithmUnsupported: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.AlgorithmUnsupported: -51>
    AuthFailed: typing.ClassVar[ErrorCode]  # value = <ErrorCode.AuthFailed: -18>
    BadMessageFormat: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.BadMessageFormat: 5>
    BadOperationOrder: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.BadOperationOrder: -39>
    BannerSendError: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.BannerSendError: -3>
    BufferTooSmall: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.BufferTooSmall: -38>
    ChannelAlreadySendEOF: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.ChannelAlreadySendEOF: -27>
    ChannelClosed: typing.ClassVar[ErrorCode]  # value = <ErrorCode.ChannelClosed: -26>
    ChannelOperationError: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.ChannelOperationError: -21>
    ChannelOrderError: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.ChannelOrderError: -20>
    ChannelPacketOversize: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.ChannelPacketOversize: -25>
    ChannelRequestDenied: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.ChannelRequestDenied: -22>
    ChannelWindowExceeded: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.ChannelWindowExceeded: -24>
    ChannelWindowFull: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.ChannelWindowFull: -47>
    CommonFailure: typing.ClassVar[ErrorCode]  # value = <ErrorCode.CommonFailure: 4>
    CompressionError: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.CompressionError: -40>
    ConnectionLost: typing.ClassVar[ErrorCode]  # value = <ErrorCode.ConnectionLost: 7>
    DataDecryptError: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.DataDecryptError: -12>
    DataEncryptError: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.DataEncryptError: -44>
    ...
    FileAlreadyExists: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.FileAlreadyExists: 11>
    FileNotExist: typing.ClassVar[ErrorCode]  # value = <ErrorCode.FileNotExist: 2>
    FileWriteProtected: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.FileWriteProtected: 12>
    FilesystemNoSpace: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.FilesystemNoSpace: 14>
    HashCalculateError: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.HashCalculateError: -54>
    HashInitError: typing.ClassVar[ErrorCode]  # value = <ErrorCode.HashInitError: -53>
    HostFingerprintMismatch: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.HostFingerprintMismatch: -46>
    HostkeyInitFailed: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.HostkeyInitFailed: -10>
    HostkeySignFailed: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.HostkeySignFailed: -11>
    InhostCopyFailed: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.InhostCopyFailed: 31>
    InvalidArg: typing.ClassVar[ErrorCode]  # value = <ErrorCode.InvalidArg: -34>
    InvalidFilename: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.InvalidFilename: 20>
    InvalidHandle: typing.ClassVar[ErrorCode]  # value = <ErrorCode.InvalidHandle: 9>
    InvalidMacAdress: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.InvalidMacAdress: -4>
    InvalidPollType: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.InvalidPollType: -35>
    InvalidSocketType: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.InvalidSocketType: -45>
    KeyExchangeFailed: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.KeyExchangeFailed: -8>
    KeyExchangeMethodNegotiationFailed: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.KeyExchangeMethodNegotiationFailed: -5>
    LocalFileError: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.LocalFileError: -16>
    LocalFileMapError: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.LocalFileMapError: 32>
    ...
    MissingUserAuthBanner: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.MissingUserAuthBanner: -50>
    ...
    NoPermissionAttribute: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.NoPermissionAttribute: 36>
    ...
    OperationTimeout: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.OperationTimeout: -9>
    OperationUnsupported: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.OperationUnsupported: 8>
    ParentDirectoryNotExist: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.ParentDirectoryNotExist: 30>
    PasswordExpired: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.PasswordExpired: -15>
    PathNotExist: typing.ClassVar[ErrorCode]  # value = <ErrorCode.PathNotExist: 10>
    PathUsingByOthers: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.PathUsingByOthers: 17>
    PermissionDenied: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.PermissionDenied: 3>
    PointerOverflow: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.PointerOverflow: -41>
    PrivateKeyAuthFailed: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.PrivateKeyAuthFailed: -48>
    PublicKeyProtocolError: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.PublicKeyProtocolError: -36>
    PublickeyAuthFailed: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.PublickeyAuthFailed: -19>
    PyTraceError: typing.ClassVar[ErrorCode]  # value = <ErrorCode.PyTraceError: 40>
    RandomGenError: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.RandomGenError: -49>
    RequestDenied: typing.ClassVar[ErrorCode]  # value = <ErrorCode.RequestDenied: -32>
    SCPProtocolError: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.SCPProtocolError: -28>
    SSHAgentProtocolError: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.SSHAgentProtocolError: -42>
    SSHEAGAIN: typing.ClassVar[ErrorCode]  # value = <ErrorCode.SSHEAGAIN: -37>
    SSHProtocolError: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.SSHProtocolError: -14>
    SessionCreateError: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.SessionCreateError: -1>
    SessionCreateFailed: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.SessionCreateFailed: 26>
    SessionHandshakeFailed: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.SessionHandshakeFailed: 27>
    SftpProtocolError: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.SftpProtocolError: -31>
    SocketConnectFailed: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.SocketConnectFailed: 25>
    SocketConnectTimeout: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.SocketConnectTimeout: 24>
    SocketCreateError: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.SocketCreateError: 23>
    SocketDisconnect: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.SocketDisconnect: -13>
    SocketOperationTimeout: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.SocketOperationTimeout: -30>
    SocketRecvError: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.SocketRecvError: -43>
    SocketSendError: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.SocketSendError: -7>
    SpaceQuotaExceed: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.SpaceQuotaExceed: 15>
    StorageMediaUnavailable: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.StorageMediaUnavailable: 13>
    ...
    UnImplentedMethod: typing.ClassVar[
        ErrorCode
    ]  # value = <ErrorCode.UnImplentedMethod: 35>
...
class OS_TYPE:
    ...
    __members__: typing.ClassVar[
        dict[str, OS_TYPE]
    ]  # value = {'Windows': <OS_TYPE.Windows: -1>, 'Linux': <OS_TYPE.Linux: 1>, 'MacOS': <OS_TYPE.MacOS: 2>, 'FreeBSD': <OS_TYPE.FreeBSD: 3>, 'Unix': <OS_TYPE.Unix: 4>, 'Unknown': <OS_TYPE.Unknown: -2>, 'Uncertain': <OS_TYPE.Uncertain: 0>}
    def __eq__(self, other: typing.Any) -> bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class PathType:
    ...
    CHARACTER_DEVICE: typing.ClassVar[
        PathType
    ]  # value = <PathType.CHARACTER_DEVICE: -2>
    ...
    __members__: typing.ClassVar[
        dict[str, PathType]
    ]  # value = {'DIR': <PathType.DIR: 0>, 'FILE': <PathType.FILE: 1>, 'SYMLINK': <PathType.SYMLINK: 2>, 'BLOCK_DEVICE': <PathType.BLOCK_DEVICE: -1>, 'CHARACTER_DEVICE': <PathType.CHARACTER_DEVICE: -2>, 'SOCKET': <PathType.SOCKET: -3>, 'FIFO': <PathType.FIFO: -4>, 'UNKNOWN': <PathType.UNKNOWN: -5>}
    def __eq__(self, other: typing.Any) -> bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class TransferTask:
    ...
    src: str
    def __init__(
        self, src: str, dst: str, size: int, path_type: PathType = ...
    ) -> None: ...
