...
ConvertStyleSnapshot_(const AMApplication::config::AMStyleSnapshot &snapshot) {
  ...
  out.style.progress_bar.lborder = snapshot.progress_bar.lborder;
  out.style.progress_bar.rborder = snapshot.progress_bar.rborder;
  out.style.progress_bar.fill = snapshot.progress_bar.fill;
  out.style.progress_bar.head = snapshot.progress_bar.head;
  out.style.progress_bar.remain = snapshot.progress_bar.remain;
