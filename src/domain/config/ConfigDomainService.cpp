 ...
 */
int64_t ClampBackupIntervalSeconds(int64_t interval_s) {
 ...
 */
int64_t ClampBackupCount(int64_t max_backup_count) {
 ...
 */
int64_t ClampLastBackupTimestamp(int64_t last_backup_s, int64_t now_s) {
  if (last_backup_s < 0) {
    return 0;
  }
