...
#if defined(RUST_TOML_READ_STATIC)
#define RUST_TOML_READ_API
#elif defined(_WIN32) || defined(_WIN64)
#if defined(RUST_TOML_READ_BUILD_DLL)
#define RUST_TOML_READ_API __declspec(dllexport)
#else
#define RUST_TOML_READ_API __declspec(dllimport)
#endif
#elif defined(__GNUC__) || defined(__clang__)
#define RUST_TOML_READ_API __attribute__((visibility("default")))
#else
#define RUST_TOML_READ_API
#endif
