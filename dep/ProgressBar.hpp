#pragma once
// deprecated
// This duplicate progress-bar implementation is non-active.
// Active progress-bar implementation: src/foundation/tools/bar.hpp
// deprecated
...
using AMProgressBarStyle = AMDomain::style::ProgressBarStyle;
class ProgressBar {
public:
...
public:
   ...
   */
  explicit BaseProgressBar(int64_t total_size = 0, std::string prefix = "",
      ...
      : total_size_(std::max<int64_t>(0, total_size)),
        ...
        prefix_fixed_width_(style.prefix_fixed_width),
        start_time_(std::chrono::steady_clock::now()),
        last_update_time_(start_time_),
        bar_(indicators::option::BarWidth{bar_width_},
             indicators::option::Start{start_token_},
             indicators::option::Fill{style.fill},
             indicators::option::Lead{style.lead},
             indicators::option::Remainder{style.remaining},
