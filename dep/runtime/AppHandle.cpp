...
AppHandle::AppHandle(
    ...
    : host_service_(host_service), known_hosts_service_(known_hosts_service),
      ...
      runtime_var_service_(runtime_var_repository_,
                           runtime_var_domain_provider_),
      var_service({}),
      managers(signal_monitor, config_.ConfigService(), config_.StyleService(),
               prompt_profile_history_manager, prompt_io_manager, host_service_,
               known_hosts_service_, host_config_manager, known_hosts_manager,
